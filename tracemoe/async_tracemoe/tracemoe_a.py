...
class AsyncTraceMoe:
    ...
    def __init__(self, *, token:Optional[str]=None) -> None:
        self.token = token # Add more stuff later
        self._error_dict = {
    ...
    async def url_search(
        ...
        async with aiohttp.ClientSession as ses: # Make this part better later.
            async with ses.get(f'{base_url}', headers=headers) as r:
